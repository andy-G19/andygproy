import {
  firebase
} from "./chunk-PODSRMXK.js";
import "./chunk-7TVDVCQM.js";
import {
  FirebaseApp,
  VERSION as VERSION2,
...
import {
  ...
  registerVersion,
  uuidv4
} from "./chunk-KYE23NZ4.js";
import {
  isPlatformServer
} from "./chunk-S3KSN7ZV.js";
import {
  Inject,
  Injectable,
  InjectionToken,
  ...
  ɵɵdefineNgModule,
  ɵɵinject
} from "./chunk-6EUZWUBK.js";
import {
  __async
} from "./chunk-RKOOZJLT.js";
...
// node_modules/.pnpm/firebase@10.14.1/node_modules/firebase/compat/app/dist/esm/index.esm.js
var name2 = "firebase";
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name3, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-EUARHYEY.js"))), map(() => ɵfirebaseAppFactory(options, zone, name3)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
